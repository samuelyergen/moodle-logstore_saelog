...
class store implements \tool_log\log\writer, \core\log\sql_internal_table_reader {
    ...
    protected function insert_event_entries($evententries) {
        ...
        $DB->insert_records('logstore_saelog', $evententries);
    }
    ...
    public function get_events_select($selectwhere, array $params, $sort, $limitfrom, $limitnum) {
        ...
        $events = array();
        $records = $DB->get_recordset_select('logstore_saelog', $selectwhere, $params, $sort, '*', $limitfrom, $limitnum);
    ...
    public function get_events_select_iterator($selectwhere, array $params, $sort, $limitfrom, $limitnum) {
        ...
        $recordset = $DB->get_recordset_select('logstore_saelog', $selectwhere, $params, $sort, '*', $limitfrom, $limitnum);
    ...
    public function get_events_select_count($selectwhere, array $params) {
        global $DB;
        return $DB->count_records_select('logstore_saelog', $selectwhere, $params);
    }

    public function get_internal_log_table_name() {
        return 'logstore_saelog';
    }
